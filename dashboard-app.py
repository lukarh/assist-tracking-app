# Run this app locally with `python dashboard-app.py` and
...
#import FLASK libraries for login
...
# import libraries to config servers
import warnings
import configparser
import os
...
# connect app / server to login atabase
...
# connect app to SQL database of Tracking Data
...
server.config.update(
    ...
    SQLALCHEMY_BINDS={
        'nbatrackingdb': 'HIDDEN FOR SECURITY REASONS',
    }
)

# initialize database in conjunction with the app
db.init_app(server)

# initialize the LoginManager for the server
